...
const company_size = document.getElementById("company_size")


const fields = [first_name, last_name, email, phone_number, company_name, company_website, job_title, company_size] //array of all field form
...
const fields_validations = {
    ...
    'company_size'         : /disabled selected/, // disabled selected mean: values select option
...
form.addEventListener("blur", function (event){
    ...
    //validation email
     ...
     //validation option company_size selector
     else if (event.target.id =='company_size'){
